...
## Project Structure
    ...
    ├── test_milestone_pric_91444  # Django project configurations
...
1. Clone this repo and `cd test_milestone_pric_91444`
...
2. Clone this repo and `cd test_milestone_pric_91444`
